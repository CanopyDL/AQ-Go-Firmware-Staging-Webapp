...
function CheckVersion(){
  ...
  .then(_ => fetch('https://raw.githubusercontent.com/CanopyDL/Aq-Go-OTA-Staging-Firmware/master/version.json'))
    ...
    Popup.create({
      ...
      buttons: {
          left: [{
              text: 'Yes',
              action: function () {
                //fetch('https://raw.githubusercontent.com/CanopyDL/Aq-Go-OTA-Firmware/' + latestCompatibleSoftware + '/GithubRepo/' + currentHardwareVersion + '.bin')
                fetch('https://raw.githubusercontent.com/CanopyDL/Aq-Go-OTA-Staging-Firmware/' + latestCompatibleSoftware + '/' + currentHardwareVersion + '.bin')
                .then(function (response) {
